...
use Reconnix\MainBundle\Entity\Configuration\Configuration;
use Reconnix\MainBundle\Form\Type\ConfigurationType;
...
class ConfigurationController extends Controller
{
    ...
    public function indexAction(){
        ...
        $config = $this->getDoctrine()->getRepository('ReconnixMainBundle:Configuration\Configuration')->find(1);
        ...
        return $this->render('ReconnixMainBundle:Admin/Configuration:admin.configuration.index.html.twig',
            array(
