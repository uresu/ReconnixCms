...
use Reconnix\MainBundle\Form\Type\TemplateType;
...
class TemplatesController extends Controller
{
    ...
    public function indexAction(){
        ...
        // fetch all Posts
        $templateObjs = $this->getDoctrine()->getRepository('ReconnixMainBundle:Content\Template')->findAll();
        ...
        return $this->render('ReconnixMainBundle:Admin/Templates:admin.templates.index.html.twig', 
    ...
    public function addAction(Request $request){
        ...
        return $this->render('ReconnixMainBundle:Admin/Templates:admin.templates.add.html.twig',
            array(
    ...
    public function editAction($id){
        ...
        $template = $this->getDoctrine()->getRepository('ReconnixMainBundle:Content\Template')->find($id);
        ...
        return $this->render('ReconnixMainBundle:Admin/Templates:admin.templates.edit.html.twig',
            array(
                'id' => $id,
                'form' => $form->createView()
            )
