...
class PostType extends AbstractType{
	...
	public function buildForm(FormBuilderInterface $builder, array $options){
        ...
        $builder->add('content', 'textarea', array('attr' => array('rows' => '35', 'cols' => '80', 'class' => 'tinymce', 'data-theme' => 'advanced')));
	...
	public function getDefaultOptions(array $options){
		return array(
			'data_class' => 'Reconnix\ContentWizardBundle\Entity\Content\Post'
		);
	}
