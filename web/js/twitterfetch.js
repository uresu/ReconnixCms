...
function handleTweets(tweets){
    ...
    var html = '<ul>';
    while(n < x) {
      html += '<li><div class="col span_1_of_8"><img src="/symfony2/path/web/images/twiter_white_27x23.png" alt=""></div><div class="col span_7_of_8"><a href="https://twitter.com/reconnix" class="social-link" style="color: rgb(0, 0, 0);">' + tweets[n] + '</a></div></li>';
      n++;
    }
    html += '</ul>';
    element.innerHTML = html;
}
twitterFetcher.fetch('430737263354339328', 'tweetlist', 2, false, false, false, '', false, handleTweets, false);